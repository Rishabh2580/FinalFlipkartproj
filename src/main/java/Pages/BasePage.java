...
public class BasePage extends Sheet {
	...
	public void launchBrowser() throws IOException, InterruptedException {
		...
		if (ReadingPropertiesfile.getProperty("mode").equalsIgnoreCase("non-headless")) {
			if (browserName.equals("chrome")) {
				extent = Extent.getInstance("reports/ExtentReports.html");
		...
		if (ReadingPropertiesfile.getProperty("mode").equalsIgnoreCase("headless")) {
			if (browserName.equals("chrome")) {
				extent = Extent.getInstance("reports/ExtentReports.html");
				WebDriverManager.chromedriver().setup();
	...
	public void launchurl(Method method) throws IOException {
		...
		FileInputStream inputStream = new FileInputStream(
				"C:\\Users\\rishabhsharma06\\eclipse-workspace\\Flipkart\\Config.Properties");
